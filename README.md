...
`Microsoft Azure` `Azure Databricks` `Azure Data Factory` `ADLS Gen2` `Azure Blob Storage` `Azure DevOps` `Microsoft Entra ID`

### ⚡ Big Data & Processing

`Apache Spark` `PySpark` `Spark SQL` `Delta Lake` `DataFrames` `Distributed Data Processing` `Batch Processing`

### 🏗️ Data Architecture

`Medallion Architecture` `Lakehouse Architecture` `ETL` `ELT` `Data Ingestion` `Data Transformation` `Data Migration` `Data Modeling` `Data Lineage`

### 🗃️ Databases & Storage

`SQL` `SQL Server` `MySQL` `PostgreSQL` `MongoDB` `Delta Tables` `Parquet` `ADLS Gen2`

### 🔧 Tools & Platforms

`Git` `GitHub` `Azure DevOps` `Unity Catalog` `ICEDQ` `VS Code` `IntelliJ IDEA` `Jupyter Notebook` `Postman`
...
A cloud-based **Data Engineering pipeline** designed to ingest, transform, process, and analyze Spotify datasets using modern Azure data engineering technologies.

### 🧰 Technology Stack

`Azure Data Factory` `ADLS Gen2` `Azure Databricks` `PySpark` `Delta Lake` `Unity Catalog`
...
* Designed an end-to-end **Azure Data Engineering pipeline** using ADF and ADLS Gen2.
...
* 🚀 **1.5+ years of professional Data Engineering experience**
* ☁️ Strong hands-on experience with **Azure Data Engineering**
* ⚡ Practical expertise in **Azure Databricks & PySpark**
* 🗃️ Strong SQL and data transformation skills
* 🔄 Experience with **ETL modernization & data migration**
* 🔍 Strong focus on **data quality and data reliability**
* 🏗️ Understanding of **Lakehouse & Medallion Architecture**
* 🧠 Analytical and problem-solving mindset
* 📚 Continuous learner focused on modern data technologies
...
I'm focused on building expertise in **Data Engineering, Cloud Computing, Big Data, Distributed Data Processing, and Modern Lakehouse Architecture**.

I'm interested in collaborating on projects involving:

`Data Engineering` `Azure` `Databricks` `PySpark` `SQL` `Apache Spark` `Delta Lake` `Big Data`

---

### ⭐ Thanks for Visiting!

Thanks for stopping by! Feel free to explore my repositories and connect with me for **Data Engineering opportunities, collaboration, and interesting technical projects**.

**Build Data. Solve Problems. Keep Learning. 🚀**
